 ...
 * @author Admin
 */
public class KhachHangView1_NhanVien extends javax.swing.JFrame {
     ...
     */
    public KhachHangView1_NhanVien() {
        initComponents();
        loaddata();
    ...
    private void btnchonkhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnchonkhActionPerformed
        ...
        for (KhachHangViewModel x : list) {
            Menu2_NhanVien.txtKhachMuaHang.setText(x.getSdt());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KhachHangView1_NhanVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
