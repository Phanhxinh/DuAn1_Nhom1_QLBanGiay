...
private MauSacIML MSiML;
    ...
    MauSac_SanphamModel  M3  = new MauSac_SanphamModel(id, ma, ten);
        return M3;
    }
    ...
    private void tbNSXMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbNSXMouseClicked
        ...
        String ma  = tbNSX.getValueAt(row, 1).toString();
        String ten  = tbNSX.getValueAt(row, 2).toString();
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        MauSac_SanphamModel MSac = this.getFromdate();
       
      
        this.MSiML.update(MSac.getMaMS(), MSac);
